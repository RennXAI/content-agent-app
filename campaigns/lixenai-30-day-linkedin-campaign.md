# LixenAI — 30-Day LinkedIn Visual Campaign
## Production Brief
...
### Canvas
- **Format:** 1080 × 1350 px (LinkedIn portrait feed)
- **Safe margin:** 64 px all sides
- **Spacing system:** 8-point grid
- **Primary corner radius:** 24 px
- **Secondary corner radius:** 16 px
...
| Deep Navy | #0C2138 |
| Lixen Blue | #1677FF |
| Electric Cyan | #25C7F4 |
| Signal Violet | #7559F2 |
| Growth Teal | #19C7A3 |
| Cloud White | #F5F8FC |
| White | #FFFFFF |
| Slate | #66758A |
...
### Typography
- **Headlines:** Sora Bold or SemiBold
- **Body / Labels:** Inter Regular, Medium, or SemiBold
- **Category labels:** Inter SemiBold, All Caps, 11–13 px, letter-spacing 0.12em
- **Headline size:** 40–56 px depending on length
- **Body size:** 16–20 px
- **Max 3 headline lines; max 7–9 headline words**
...
### Visual Rules
- One dominant focal point per graphic
- Max three accent colors per graphic
- No robots, AI brains, fake money, or holographic clutter
- Thin 1 px borders in Lixen Blue (#1677FF) or Electric Cyan (#25C7F4)
- Shadows: 0 8px 32px rgba(0,0,0,0.25) on dark; 0 4px 16px rgba(7,20,38,0.08) on light
- Glass-panel effect: background rgba(255,255,255,0.06), border rgba(37,199,244,0.18)

### Recruitment Disclosure (required verbatim on all Partner recruitment posts)
...
| Treatment | Count | Days |
|---|---|---|
| Dark technology cards | 14 | 1, 2, 4, 8, 9, 11, 16, 17, 18, 20, 23, 25, 27, 28 |
| Light educational cards | 7 | 3, 7, 10, 12, 14, 19, 22, 29 |
| Photography-led | 5 | 5, 13, 24, 26, 30 |
| Product screenshots | 3 | 6, 15, 26 |
| Poll / simple text | 1 | 21 |

---

## Template Family Index

| # | Template Name | Core Purpose |
|---|---|---|
| T1 | Brand Statement | Anchor the primary brand promise |
| T2 | Partner vs LixenAI Split | Clarify the division of responsibility |
| T3 | Workflow Explainer | Show a specific automated process |
| T4 | Pain vs System | Contrast the old way with LixenAI |
| T5 | Product Feature Spotlight | Surface one product capability |
...
**Cadence Role:** Brand anchor — sets the campaign's visual language and core promise
...
**Primary Headline (Sora Bold, 56 px, White, centered):**
> You sell.
> LixenAI builds,
...
We spent a long time watching talented salespeople burn out maintaining tech they should never have had to touch.

LixenAI was built around one principle: the person who sells should never be the person managing infrastructure.

You own the relationship. You run the sale. We build, deploy, optimize, and support everything behind it.

That's the entire model.

Over the next 30 days we're going to show you exactly what that looks like — inside the system, inside the numbers, and inside the real workflows that run for our clients.
...
## Day 2 — Responsibility Split

**Template:** T2 — Partner vs LixenAI Split
**Visual Treatment:** Dark technology card
...
**Category Label:** `CLARITY ON ROLES` — Inter SemiBold, all caps, Slate, 12 px, top-left

**Primary Headline (Sora SemiBold, 44 px, White, left-aligned):**
> Two roles.
> One powerful system.

**Layout:** Two full-width rounded panels stacked vertically, 24 px gap between them. Each panel 16 px corner radius, 1 px border.

**Panel A — YOU (Sales Partner)**
- Background: rgba(22,119,255,0.10), border #1677FF 1px
- Label: `YOU — SALES PARTNER` Inter SemiBold, all caps, Lixen Blue, 12 px
- Content (Inter Medium, 16 px, White, line-height 1.7):
...
**Panel B — LIXENAI**
- Background: rgba(37,199,244,0.08), border #25C7F4 1px
- Label: `LIXENAI — OPERATING SYSTEM` Inter SemiBold, all caps, Electric Cyan, 12 px
- Content (Inter Medium, 16 px, White, line-height 1.7):
  - Build and deploy the platform
  - Manage AI workflows and automations
  - Handle technical fulfillment
  - Provide support, optimization, and updates

**Thin horizontal divider** between panels: 1 px, gradient Lixen Blue → Electric Cyan, full panel width, centered in the 24 px gap.

**Supporting Message (Inter Regular, 15 px, Slate, centered, bottom zone):**
> Neither role has to do the other's job. That's the point.
...
The most common friction in any partnership is unclear ownership.

At LixenAI we eliminated it from day one.

You handle everything in front of the client — prospecting, demos, follow-up, close. We handle everything behind it — infrastructure, deployment, AI automation, support, and ongoing optimization.

No one crosses the line. No one gets left holding a technical problem they can't solve.

The system works because the roles are airtight.

That's what we mean when we say operational AI.

**#LixenAI #SalesPartner #BusinessSystems #AIAutomation #ClarityOfRoles**

---

## Day 3 — Pain vs System

**Template:** T4 — Pain vs System Comparison
**Visual Treatment:** Light educational card

### Canvas Specification

**Background:** Cloud White (#F5F8FC), full-bleed.

**Category Label:** `THE OLD WAY VS. THE LIXENAI WAY` — Inter SemiBold, all caps, Slate, 11 px, top-left. Add a thin 1 px left-border accent in Lixen Blue, 16 px tall.
...
**Column A — WITHOUT LIXENAI**
- Header bar: Alert Coral (#FF6B6B) 4 px rounded-top, full width
- Label: `WITHOUT LIXENAI` Inter SemiBold, all caps, Alert Coral, 12 px
- Background: White, 16 px radius, 1 px border #E5E9F0
- Items (Inter Regular, 15 px, Charcoal, 1.7 line-height, bullet: × in Coral):
  - × Missed calls = lost revenue
  - × Manual follow-up gets forgotten
  - × No-shows with no recovery
  - × Reviews never requested
  - × Pipeline lives in a spreadsheet

**Column B — WITH LIXENAI**
- Header bar: Growth Teal (#19C7A3) 4 px rounded-top
- Label: `WITH LIXENAI` Inter SemiBold, all caps, Growth Teal, 12 px
- Background: White, 16 px radius, 1 px border #E5E9F0
- Items (Inter Medium, 15 px, Charcoal, bullet: ✓ in Teal):
  - ✓ Every missed call gets an instant AI response
  - ✓ Follow-up sequences run automatically
  - ✓ No-shows trigger rebooking workflows
  - ✓ Reviews requested after every appointment
...
Missed calls answered. Follow-up automated. Reviews collected. No-shows recovered. Pipeline live.
...
## Day 4 — Workflow Explainer

**Template:** T3 — Workflow Explainer
**Visual Treatment:** Dark technology card

### Canvas Specification

**Background:** Midnight (#071426), subtle diagonal texture at 3% opacity (very fine dot grid in Deep Navy).

**Category Label:** `HOW IT WORKS` — Inter SemiBold, all caps, Electric Cyan, 12 px, top-left
...
**Connector lines:** 1 px dashed, Electric Cyan, 8 px tall, centered between cards.

**Supporting Message (Inter Regular, 15 px, Slate):**
> Your Sales Partner handles steps 3 and 4. LixenAI handles everything else.
...
Here's what happens when a new lead comes in through a LixenAI-powered business:
...
- Gradient overlay: transparent from top 40% → Midnight (#071426) at bottom 100%, opacity 85%
- Subtle vignette at all four edges

**UI Overlay Panel** (floating bottom-left, 520 px wide, glass card):
- Background: rgba(12,33,56,0.82), blur 12px
- Border: 1 px, rgba(37,199,244,0.30)
- Corner radius: 16 px
- Padding: 24 px
...
**Supporting Message (Inter Regular, 17 px, Cloud White at 80%):**
> The lead didn't slip. It converted.
...
In a LixenAI-powered business, the system detects the missed call and sends an AI-written text response within four seconds:

"Hi! You just tried to reach [Business Name]. We'd love to connect — are you looking to book a consultation?"

The prospect replies. The appointment gets booked. The owner finds out when she checks the CRM.

She never had to touch it.
...
## Day 6 — Product Feature Spotlight

**Template:** T5 — Product Feature Spotlight
**Visual Treatment:** Product screenshot
...
## Day 7 — Educational Carousel

**Template:** T10 — Educational Carousel
**Visual Treatment:** Light educational card (cover + 5 interior panels)
**Note:** Post as LinkedIn carousel (PDF or multi-image). Each panel 1080 × 1350 px.

### Panel 1 — Cover

**Background:** Cloud White (#F5F8FC)
**Category Label:** `EDUCATIONAL SERIES` — Inter SemiBold, all caps, Slate, 11 px, top-left, left-border accent Lixen Blue
**Primary Headline (Sora Bold, 52 px, Charcoal):**
> 6 things LixenAI
> handles so you
> don't have to.

**Supporting note (Inter Regular, 17 px, Slate):** Swipe to see each workflow →
**Logo:** Charcoal wordmark, bottom-right
**Decorative:** Thin horizontal gradient line below headline: Lixen Blue → Electric Cyan → Growth Teal, 400 px wide, 2 px
...
**Body:** After a lead is captured, a multi-touch sequence runs automatically — by text, by email — until the prospect books or opts out.

### Panel 4

**Number:** `03`
**Headline:** No-show rebooking
**Body:** When a client doesn't show, LixenAI detects it and triggers a rebooking message within the same day. Revenue recovered without a single manual task.

### Panel 5

**Number:** `04`
**Headline:** Review request automation
**Body:** After each completed appointment, the system sends a review request at the optimal time. Ratings go up. Reputation compounds.

### Panel 6

**Number:** `05`
**Headline:** Pipeline and CRM updates
**Body:** Every lead action — call, text, booking, no-show, review — is logged automatically. Your pipeline reflects reality, not memory.

### Panel 7 (Final)

**Background:** Deep Navy
**Headline (Sora Bold, 44 px, White):** Your Sales Partners run the room. LixenAI runs the system.
**CTA:** `Apply to become a Sales Partner` — Inter SemiBold, Electric Cyan, 16 px
**Logo:** White wordmark, bottom-right
...
Here are the 6 workflows LixenAI runs automatically for every client:

01 — Missed call recovery
02 — Automated follow-up sequences
03 — No-show rebooking
04 — Review request automation
05 — Pipeline and CRM updates
06 — Appointment confirmation and reminders
...
**Background:** Midnight (#071426) with a horizontal color band at 30% canvas height — 120 px tall, gradient from Lixen Blue at 8% opacity to transparent. Subtle top-right corner glow in Signal Violet, 400 px, 20% opacity.

**Category Label:** `BUILT FOR SCALE` — Inter SemiBold, all caps, Slate, 12 px

**Primary Headline (Sora Bold, 54 px, White, centered):**
> Build once.
> Deploy everywhere.
> Sell indefinitely.
...
The traditional consulting model trades time for money.

Every new client = new hours. New complexity. New overhead.

LixenAI flips the ratio.

One Sales Partner deploys one system — and that system serves every client they bring on. The infrastructure doesn't change. The capacity doesn't shrink.

This is what scalable revenue looks like.

Not hustle. Infrastructure.

**#LixenAI #ScalableRevenue #SalesPartner #AIBusiness #OperationalAI**

---

## Day 9 — Objection Response
...
**Body (Inter Regular, 17 px, Cloud White, 1.75 lh):**
A chatbot answers questions.

LixenAI runs the entire operational layer of a business — lead intake, qualification, follow-up, booking, recovery, reviews, and pipeline — automatically and in sequence.
...
And honestly — fair question. The AI space is noisy, and most of what's being sold is, in fact, just a chatbot with a $300/month price tag.

LixenAI is not that.

A chatbot handles one interaction at a time when someone talks to it.

LixenAI runs six automated workflows continuously, in the background, across every client business — whether anyone is looking or not.

Missed calls recovered. Follow-up sent. No-shows rebooked. Reviews collected. CRM updated.

That's an operating system. Not a chatbot.

**#LixenAI #AIFacts #NotAChatbot #OperatingSystem #BusinessAutomation**

---

## Day 10 — Partner Recruitment (Intro)

**Template:** T8 — Partner Recruitment
**Visual Treatment:** Light educational card
...
We're expanding our Sales Partner network.
...
LixenAI handles deployment, onboarding, training, technical support, and optimization — from the moment you hand off.
...
## Day 11 — Workflow Explainer (Pipeline)
...
Ask most business owners where any given lead stands right now.

Most of them will hesitate.

A CRM that requires manual updates is a CRM that's always out of date.

LixenAI logs every interaction — call, text, reply, booking, no-show — automatically, in real time, to the pipeline.

Your Sales Partner sees the full picture. The business owner sees the full picture.

No one is guessing.

That's what an intelligent pipeline looks like.

**#LixenAI #CRM #PipelineManagement #SalesIntelligence #AIForSales**

---

## Day 12 — Pain vs System (Hiring vs Deploying)

**Template:** T4 — Pain vs System
**Visual Treatment:** Light educational card
...
**Category Label:** `A DIFFERENT CALCULATION` — Inter SemiBold, all caps, Slate, 11 px, top-left, left-border Lixen Blue

**Primary Headline (Sora Bold, 44 px, Charcoal):**
> Hiring a team
> vs. deploying
> a system.
...
**Column A — HIRING**
Header: Alert Coral bar, `HIRING A TEAM`
Items (Inter Regular, 15 px, Charcoal):
- $55–80K salary per person
- 2–4 week ramp time
- Sick days, turnover, retraining
- Inconsistent execution
- Scales with headcount, not revenue

**Column B — LIXENAI**
Header: Growth Teal bar, `DEPLOYING LIXENAI`
Items (Inter Medium, 15 px, Charcoal):
- Fixed monthly infrastructure cost
- Live within days of onboarding
...
LixenAI fills the systems gap without adding payroll.
...
**Image Treatment:**
- Full-bleed photo
- Bottom 50%: Midnight gradient overlay, 80% opacity
- Subtle vignette
...
The best sales professionals I've met all share one frustration:

They spend too much time on things that aren't the sale.

Chasing leads that should have been followed up automatically. Updating a CRM that should update itself. Recovering no-shows that should have been rebooked by the system.

LixenAI Sales Partners don't have that problem.

The platform handles the operational layer. They handle the human layer.

That's what frees a good sales professional to become a great one.

**#LixenAI #SalesPartner #B2BSales #SalesProductivity #AIForSales**

---

## Day 14 — Founder Perspective

**Template:** T7 — Founder Perspective
**Visual Treatment:** Light educational card
...
**Category Label:** `WHY WE BUILT THIS` — Inter SemiBold, all caps, Lixen Blue, 12 px, top-left, left-border accent
...
Missed calls with no follow-up. Follow-up with no sequence. No-shows with no recovery. Reviews never asked. Pipelines never updated.

Each one is solvable. Combined, they compound into a slow, invisible revenue leak.

LixenAI was built to seal the leak — permanently, at the systems level.

**Closing line (Inter SemiBold, 16 px, Lixen Blue):**
> "You deserve infrastructure that works as hard as you do."
...
No person can be on everything, all the time.
...
## Day 15 — Product Feature (AI Follow-Up)
...
Here's the honest truth about follow-up:

The businesses that win are usually not doing more follow-up. They're doing it more consistently.

That's what LixenAI solves.

Every new lead enters an automated sequence:
Day 0 — Initial outreach
Day 1 — First follow-up
Day 3 — Second touch
Day 5 — Re-engagement message
Day 7 — Final touch

The moment a prospect replies, the sequence stops. A notification goes to the Sales Partner. The conversation becomes human.
...
## Day 16 — Partner vs LixenAI Split (Detailed)

**Template:** T2 — Partner vs LixenAI Split (expanded)
**Visual Treatment:** Dark technology card
...
**Primary Headline (Sora Bold, 40 px, White):**
> Every moving part.
...
People ask us all the time: "So who's responsible for what?"

Here's the complete answer.

**Sales Partner owns:**
Prospecting, discovery, demonstrations, negotiation, close, relationship

**LixenAI owns:**
Deployment, AI configuration, onboarding, automation, integrations, CRM, support, updates

There is no grey zone. No task that belongs to both parties and therefore falls through the middle.
...
## Day 18 — Objection Response (Does It Work?)
...
**Background:** Deep Navy (#0C2138). Thin 1 px horizontal lines at 25% and 75% height, Electric Cyan, 10% opacity.
...
**Body (Inter Regular, 17 px, Cloud White, 1.75 lh):**
That's why we don't sell abstractions.
...
**Closing Line (Inter SemiBold, 16 px, Growth Teal):**
> "Seeing is the whole point of a demo."

**Thin separator:** 1 px, Lixen Blue → Electric Cyan gradient, 80% width
...
This is a fair objection and we take it seriously.

The AI space is full of bold claims with no substance behind them. We understand why skepticism is the right starting position.
...
## Day 19 — Educational Carousel (The 6 Workflows)

**Template:** T10 — Educational Carousel
**Visual Treatment:** Light educational card (cover + 7 panels)

### Panel 1 — Cover

**Background:** Cloud White
**Category Label:** `THE LIXENAI SYSTEM`
**Headline (Sora Bold, 52 px, Charcoal):**
> The 6 workflows
> running inside every
> LixenAI deployment.
**Subline:** Swipe to understand the full system →
...
**Workflow 02:** Lead Qualification
**Headline:** AI pre-qualifies every inbound lead before the Sales Partner sees them.
**How it works:** Message received → Intent detected → Prospect scored and staged in CRM

### Panel 4

**Workflow 03:** Follow-Up Sequences
**Headline:** Multi-touch follow-up that runs until a response is received.
**How it works:** Lead added → Sequence launched → Stops on reply → Hands off to Sales Partner

### Panel 5

**Workflow 04:** No-Show Recovery
**Headline:** Missed appointments trigger automatic rebooking within hours.
**How it works:** No-show detected → Recovery message sent → Rescheduling offered → CRM updated

### Panel 6

**Workflow 05:** Review Requests
**Headline:** After every appointment, the system asks for a review.
**How it works:** Appointment completed → Review request sent → Response logged → CRM updated

### Panel 7

**Workflow 06:** Pipeline Automation
**Headline:** Every action updates the pipeline. No manual entry.
**How it works:** Any lead event → Auto-logged to CRM → Stage updated → Notifications sent
...
Six workflows. Running continuously. For every LixenAI client.
...
04 — No-Show Recovery
05 — Review Requests
06 — Pipeline Automation

Swipe through to see how each one works — and what triggers it.
...
## Day 20 — Workflow Explainer (Review Automation)
...
**Primary Headline (Sora Bold, 44 px, White):**
> The review that gets
> requested every time
> — automatically.

**Workflow Cards (5 stacked, each 880 px wide × 80 px, 16 px radius, Deep Navy bg, 1 px border):**

| Step | Border Color | Label | Detail |
|---|---|---|---|
...
LixenAI requests a review from every client, 1–2 hours after their appointment, automatically. Personalized. Via their preferred channel.

The system doesn't forget. It doesn't feel awkward. It just asks.
...
**Headline (Sora SemiBold, 44 px, Charcoal):**
> What's the biggest
> follow-up problem
> in your business?
...
**Poll Options:**
A) Forgetting to follow up entirely
B) Following up too late
C) No organized process at all
D) Too many leads to track manually
...
Real question — and we read every answer.

What's the biggest follow-up challenge in your business?
...
## Day 22 — Partner Recruitment (Income Model)
...
**Category Label:** `SALES PARTNER ECONOMICS` — Inter SemiBold, all caps, Lixen Blue, 12 px, top-left, left-border accent
...
→ LixenAI deploys the system
→ You earn on that client's active subscription

The more clients you close, the more the income compounds. There's no ceiling built into the structure — only what your pipeline can support.

We give you the product, the training, the demo environment, and the infrastructure. You bring the relationships and the discipline.
...
The LixenAI Sales Partner model isn't complicated.

You close a client. We deploy the system. The client stays active. The structure rewards you for every month they do.

You don't build the product. You don't handle support. You don't manage infrastructure.

You sell.

What determines your income isn't a salary band or an hourly rate — it's your close rate and your pipeline discipline.

If that model fits how you think about your time and your output, it's worth a conversation.

Link in comments.

*Independent, performance-based Sales Partner opportunity. Not salaried employment. Income is not guaranteed.*

**#LixenAI #SalesPartner #PerformanceIncome #B2BSales #SalesOpportunity**

---

## Day 23 — Brand Statement (Scale)
...
**Divider:** 1 px gradient line, 60% width, centered

**CTA:** LixenAI.com — Inter Medium, 15 px, Electric Cyan
...
The question we hear from serious Sales Partners is always some version of:

"What happens when I close 10 clients? 20? 50?"

The answer is: the system handles it.

LixenAI's infrastructure doesn't require proportional growth on our side. Each new client deployment runs on the same platform. The operational load doesn't scale linearly with client count.

For the Sales Partner, that means the ceiling on your pipeline is a function of your time and relationships — not our capacity.

Build the network. The system keeps up.

**#LixenAI #ScalableAI #SalesPartner #Infrastructure #BusinessScale**
...
**Image Treatment:**
- Full-bleed
- Bottom 55%: Midnight gradient, 85% opacity
- Soft vignette
...
**Primary Headline (Sora Bold, 48 px, White, bottom-left):**
> The call that
> changes the
> business.

**Supporting Message (Inter Regular, 17 px, Cloud White at 80%):**
> Every LixenAI Sales Partner runs this conversation.
...
Not because it's a weakness to exploit — but because it's a real problem with a real solution.

LixenAI Sales Partners are trained to run discovery as a diagnostic, not a script.
...
## Day 25 — Pain vs System (Manual Chase vs Pipeline)
...
**Primary Headline (Sora Bold, 46 px, White):**
> Manual lead
> management is a
> leak, not a process.
...
Items (Inter Regular, 15 px, Cloud White):
- Lead comes in → sits in email
- Follow-up depends on memory
- No-show → slot lost, never recovered
- Review never requested
- Pipeline updated when someone remembers

**Panel B — LIXENAI**
Background: rgba(25,199,163,0.10), border 1 px Growth Teal
Label: `WITH LIXENAI`
Items (Inter Medium, 15 px, White):
- Lead comes in → system acts in seconds
- Follow-up runs automatically
- No-show → recovery message sent same day
- Review requested within 2 hours
- Pipeline updated on every action

**Closing callout (Glass panel, centered, 24 px padding):**
(Inter SemiBold, 16 px, White) "The gap between these two isn't skill. It's infrastructure."
...
There's a version of "working hard" that looks like this:

Checking email for leads. Manually following up. Hoping the no-show reschedules. Forgetting to ask for a review. Updating the CRM on Friday when you can't remember what happened Monday.

None of this is bad work ethic. It's the absence of a system doing what it should.

LixenAI closes the gap between intention and execution.

The result isn't just efficiency — it's compounding. Every lead handled. Every opportunity recovered. Every review requested.
...
## Day 26 — Product Feature (Pipeline View)

**Template:** T5 — Product Feature Spotlight
**Visual Treatment:** Product screenshot + photography hybrid
...
The question a business owner should be able to answer at any moment:

"Where are my leads right now?"

Not approximately. Not "I think we have a few in follow-up." Exactly.

LixenAI's pipeline view shows every active prospect, their stage, their last interaction, and what's queued next — updated in real time, automatically.

No one inputs the data. The system does.
...
**Supporting Message (Inter Regular, 15 px, Slate):**
> Happened at 6:43 PM. No staff. No manual entry. Just the system.
...
**Category Label:** `REAL QUESTION` — Inter SemiBold, all caps, Slate, 12 px

**Objection (Inter SemiBold, 20 px, Signal Violet, italic, left accent bar):**
> "What do I need to become a Sales Partner?"
...
You need to run a great discovery conversation and close the solution.

We handle everything after the handoff.
...
The question we get before most applications:

"What do I actually need to get started?"

The short answer: good communication skills, a consultative mindset, and a willingness to learn the product.

That's it.

You don't need to understand APIs. You don't need to know how the automations are built. You don't need to code, configure, or maintain anything.

LixenAI provides the product training, the demo environment, and the full technical support layer.

You bring the ability to build trust, identify problems, and close solutions.

If that's you — we should talk.

*Independent, performance-based Sales Partner opportunity. Not salaried employment. Income is not guaranteed.*

**#LixenAI #SalesPartner #SalesJobs #B2BSales #NoTechRequired**

---

## Day 29 — Partner Recruitment (Who Thrives)
...
**Category Label:** `IS THIS FOR YOU?` — Inter SemiBold, all caps, Lixen Blue, 12 px, left-border accent
...
**List Panel (White bg, 1 px border #E5E9F0, 16 px radius, 24 px padding):**
...
— Anyone who expects results without building a pipeline
...
The LixenAI Sales Partner opportunity is genuinely good for the right person. It's not the right move for everyone.

**It's a strong fit if:**
→ You have B2B sales or consultative selling experience
→ You understand performance-based income
→ You want to sell a real product that solves a real problem
→ You can build and work a pipeline consistently

**It's probably not a fit if:**
→ You're looking for quick passive income
→ You need a salary from week one
→ You prefer inbound-only selling

No pressure. No hype. If the description fits how you already operate — let's talk.
...
**Primary Headline (Sora Bold, 56 px, White, left-aligned):**
> You sell.
> LixenAI builds,
> deploys, and fulfills.
...
**Thin separator:** 1 px, gradient Lixen Blue → Growth Teal, 300 px wide

**CTA (Inter SemiBold, 15 px, Electric Cyan):**
> Join the network at LixenAI.com
...
Thirty days ago, we made a promise: show you exactly what LixenAI is, how it works, and who it's built for.

Not hype. Not vague AI imagery. Not fake dashboards or invented results.

Just the system — workflows, responsibility, product, and proof.

If you followed along: thank you. If you're just finding us: start from Day 1.
...
The business grows. Neither side carries the other's burden.

That's the model. It's live. It's working. And the network is growing.

If you're a Sales Partner looking for a product worth selling — or a business owner ready to stop running on manual effort — reach out.
...
Colors: Slate (default) / Electric Cyan (dark cards) / Lixen Blue (light cards)
Left accent: 2 px solid, Lixen Blue, 16 px tall (light cards only)
```

### Glass Card Component
```
Background: rgba(255,255,255,0.06)
Border: 1 px solid rgba(37,199,244,0.18)
Border-radius: 16 px
...
### Feature Tag Pill Component
```
Background: transparent
Border: 1 px solid #25C7F4
Color: #25C7F4
...
### Workflow Step Card (Dark)
```
Background: #0C2138
Border: 1 px solid (step-color)
Border-radius: 16 px
Height: 72 px
Width: 880 px
Padding: 0 24 px
Font: Inter Medium, 15 px, White (label) / Slate (description)
Step number: Inter SemiBold, 12 px, Slate
```
...
Posts requiring the recruitment disclosure (verbatim):
*"Independent, performance-based Sales Partner opportunity. Not salaried employment. Income is not guaranteed."*
